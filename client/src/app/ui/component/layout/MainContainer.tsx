...
import { RegisterPreConfirmEmailPage } from "../../page/user/RegisterPreConfirmEmailPage";
  ...
  return (
    ...
    <div id="MainContainer" data-testid="MainContainer" className="main-container">
      <Switch>
        ...
        <Route path="/user/confirm" component={RegisterPreConfirmEmailPage} exact></Route>
